...
export const metadata: Metadata = {
  ...
  description:
    "The ultimate source for YouTube drama, scandals, and 'what happened to' stories. Discover the truth behind your favorite creators' controversies and disappearances.",
  keywords:
    "youtube drama, youtuber recap, what happened to, youtube scandals, influencer drama, content creator news, youtube tea, creator updates",
  openGraph: {
    title: "YouTuber Recap - What Happened to Your Favorite YouTube Stars",
    description:
      "The ultimate source for YouTube drama, scandals, and 'what happened to' stories.",
    ...
    <html lang="en">
      <head>
        ...
        <meta
          ...
          content="ecuWDSWw0HgZ78OQ9OSFbF8dGR9NXI5Orh71HtTKd9A"
        />
      </head>
      <body
        ...
        <header className="py-4 mb-4 border-b border-border sticky top-0 bg-background/95 backdrop-blur-sm z-50">
          <div className="container mx-auto px-6 py-3">
            <div className="flex items-center justify-between">
              <Link
                href="/"
                className="text-xl font-bold text-primary hover:text-primary/80 transition-colors font-serif"
              >
                YouTuber Recap
              </Link>
              <nav className="hidden md:flex items-center gap-8">
                <Link
                  href="/youtube-drama-2024"
                  className="text-sm hover:text-primary transition-colors"
                >
                  Latest Drama
                </Link>
                <Link
                  href="/what-happened-to"
                  className="text-sm hover:text-primary transition-colors"
                >
                  Where Are They Now
                </Link>
                <Link
                  href="/youtube-scandals"
                  className="text-sm hover:text-primary transition-colors"
                >
                  Scandals
                </Link>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div className="space-y-3">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  YouTuber Recap is your ultimate source for YouTube drama,
                  creator updates, and the stories behind the scandals.
                </p>
              </div>
            </div>
